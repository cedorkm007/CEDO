  ...
  if (currentScholarIdNumber) {
    return (
      <div className="flex items-center gap-1.5 text-[12.5px]">
        ...
        <button onClick={() => setEditing(true)} className="text-[#0088cc] font-semibold hover:underline">Change</button>
        <button onClick={onClear} className="text-red-400 hover:text-red-600 font-semibold hover:underline">Clear</button>
      </div>
    );
  }

  return (
    <button onClick={() => setEditing(true)} className="text-[12.5px] text-slate-400 italic hover:text-[#0088cc] hover:not-italic">
