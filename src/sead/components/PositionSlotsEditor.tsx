          ...
          <div key={group.roleKey}>
            ...
            {addingGroup === group.roleKey ? (
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => addExpandableSlot(group.roleKey)} style={{ cursor: 'pointer' }} className="text-[12.5px] font-bold text-[#0088cc] hover:opacity-80 transition-opacity">Add</button>
                <button onClick={() => { setAddingGroup(null); setNewLabel(""); }} style={{ cursor: 'pointer' }} className="text-[12.5px] text-slate-400 hover:opacity-80 transition-opacity">Cancel</button>
              </div>
            ) : (
              <button onClick={() => setAddingGroup(group.roleKey)} style={{ cursor: 'pointer' }} className="flex items-center gap-1.5 text-[12.5px] font-semibold text-[#0088cc] hover:underline hover:opacity-80 transition-opacity">
